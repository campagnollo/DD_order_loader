...
def order_pull():
    sites = yaml_reader()
    wsheet_id = sheet.get_worksheet_by_id(sites['cava_nyc']["wsheet_id"])
    i = sites['cava_nyc']["placeholder"]
    order_list, new_place = data_presense(i, wsheet_id, sites, 'cava_nyc')
    sites['cava_nyc']["placeholder"] = new_place
